...
server.tool("create_canvas", "Create an HTML canvas on gui.new and get a shareable URL", {
...
server.tool("create_markdown_canvas", "Create a markdown canvas on gui.new (rendered server-side) and get a shareable URL", {
...
server.tool("create_multi_frame", "Create a multi-frame canvas on gui.new with multiple HTML panels", {
    frames: z
        .array(z.object({
